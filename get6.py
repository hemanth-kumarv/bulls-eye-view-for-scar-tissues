...
def saveSegments(img):
    ...
    corner2 = np.array([[(0,0), mid, (0,Y/2)]], dtype=np.int32)
    corner3 = np.array([[(0,Y/2), mid, (0, Y)]], dtype=np.int32)
    corner4 = np.array([[(0, Y), mid, (X,Y)]], dtype=np.int32)
    corner5 = np.array([[(X,Y), mid, (X,Y/2)]], dtype=np.int32)
    corner6 = np.array([[(X,Y/2), mid, (X,0)]], dtype=np.int32)
